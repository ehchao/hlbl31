...
namespace QDP
{
  ...
  public:
    ...
    //! Do a sumMulti(cf*phases,getSet())
    multi2d<DComplex> sftp(const LatticeComplex& cf) const;

    //! Do a sum(cf*phases,getSet()[my_subset])
    multi2d<DComplex> sftp(const LatticeComplex& cf, int subset_color) const;

    //! Do a sumMulti(cf*phases,getSet())
    multi2d<DComplex> sftp(const LatticeReal& cf) const;

    //! Do a sumMulti(cf*phases,getSet()[my_subset])
    multi2d<DComplex> sftp(const LatticeReal& cf, int subset_color) const;
